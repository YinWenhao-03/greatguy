      ...
      achievements: [
        {
          title: "销售策略标准化话术手册迭代",
          description:
            "负责“全国购”电销业务标准化建设，通过质检高转化电销录音萃取高销经验，参与迭代《全国购基础话术 1.0》。将非标经验转化为可复制 SOP。",
        },
        {
          title: "销售周期管理",
          description:
            "统筹新人入职 28 天成长全链路运营，设计并执行“预习-面授-通关考试-实战陪跑-复盘”闭环路径。建立新人成长档案动态监测销售漏斗数据（拨打量 → 通时 → 线索转化），推动“培训考核结果与销售绩效挂钩”策略落地。",
        },
        {
          title: "加盟商数据运营",
          description:
            "负责对接区域 BD，对现有 96 家加盟商 4000 余位同学全量合规认证，通过线上课程配置、数据运营、结果回收，完成“学-考-认证”闭环管理。撰写加盟商区域经理满意度年度分析报告，为精细化流程闭环提供参考。",
=======
          title: "销售话术迭代",
          description:
